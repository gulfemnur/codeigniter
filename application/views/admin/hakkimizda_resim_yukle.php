                            ...
                            <div class="box">
                                ...
                                <div id="collapseOne" class="accordion-body collapse in body">
                                    * Yüklenecek resim dosyası türleri (gif|jpg|png) max boyutlar: 1024x1024 , boyut: 100kb
                                    ...
                                    <form enctype="multipart/form-data" action="<?=base_url()?>admin/hakkimizda/resim_kaydet/<?=$id?>" method="post" class="form-horizontal" id="block-validate" novalidate="novalidate">
