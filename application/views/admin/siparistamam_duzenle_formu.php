                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                <header>
                                    ...
                                    <h5>TAMAMLANAN SİPARİŞ DÜZENLEME</h5>
                                    <div class="toolbar">
                                        <ul class="nav">
                                            <li>
                                                <div class="btn-group">
                                ...
                                <div id="collapseOne" class="accordion-body collapse in body">
                                    <form action="<?=base_url()?>admin/siparistamam/guncelle/<?=$veri[0]->Id?>" method="post" class="form-horizontal" id="block-validate" novalidate="novalidate">
