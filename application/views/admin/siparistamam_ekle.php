                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                <header>
                                    ...
                                    <h5>TAMAMLANAN SİPARİŞ EKLEME</h5>
                                    <div class="toolbar">
                                        <ul class="nav">
                                            <li>
                                                <div class="btn-group">
                                ...
                                <div id="collapseOne" class="accordion-body collapse in body">
                                    <form action="<?=base_url()?>admin/siparistamam/ekle_kaydet" method="post" class="form-horizontal" id="block-validate" novalidate="novalidate">

                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Ürün Adı</label>
                                            <div class="col-lg-4">
                                                <input type="text" id="urun_adi" name="urun_adi" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
