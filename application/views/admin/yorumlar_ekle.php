                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="collapseOne" class="accordion-body collapse in body">
                                    <form action="<?=base_url()?>admin/yorumlar/ekle_kaydet" method="post" class="form-horizontal" id="block-validate" novalidate="novalidate">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="editor" name="mesaj" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
